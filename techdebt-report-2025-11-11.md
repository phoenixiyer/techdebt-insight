...
**Repository:** `.`  
**Generated:** 11/11/2025, 10:35:11 am  
...
|--------|-------|--------|-------------------|
| **Technical Debt Ratio** | 75.8% | Critical | 15% |
| **Code Quality Score** | 10/100 | Critical | 75/100 |
| **Defect Density** | 27.29/1K LOC | Critical | 1/1K LOC |
| **Test Coverage** | 0.0% | Critical | 70% |
| **Maintenance Cost Ratio** | 100.0% | Critical | 30% |

### 💰 Financial Impact

- **Estimated Remediation Cost:** $10,837.5
- **Time to Fix:** 3.6 weeks
- **Monthly Maintenance Burden:** $10,837.5
- **Annual Technical Debt Cost:** $1,30,050
...
| **Quality** | Total Issues | 130 |
| | Critical Issues | 6 |
| | Security Vulnerabilities | 6 |
| | Code Smells | 124 |
| **Complexity** | Avg Cyclomatic | 2683.1 |
| | Avg Cognitive | 209.2 |
...
- **Average Cyclomatic Complexity:** 2683.1 ⚠️ High
- **Average Cognitive Complexity:** 209.2
...
| **Compliance Risk** | 48/100 | 🟡 Moderate |
...
3. **[CRITICAL]** File 'pdfGenerator.ts' has 529 lines (recommended: < 500 lines). Consider splitting into smaller modules. in `src/reports/pdfGenerator.ts:undefined`
4. **[CRITICAL]** eval() usage detected. This can lead to code injection vulnerabilities. in `src/analyzers/security.ts:140`
5. **[CRITICAL]** File 'aiCodeDetectorV2.ts' has 554 lines (recommended: < 500 lines). Consider splitting into smaller modules. in `src/analyzers/aiCodeDetectorV2.ts:undefined`
...
|--------|------------|--------|--------------|-----|--------|
| **Technical Debt Ratio** | 75.8 | 5.0 | 15.0 | +70.8 | Critical |
| **Defect Density (per 1K LOC)** | 27.3 | 0.5 | 1.0 | +26.8 | Critical |
...
- **Immediate Fixes:** $3,251.25 (Critical + High priority)
- **Complete Remediation:** $10,837.5
...
- **Maintenance Cost Savings:** $4,335/year
...
*Timestamp: 2025-11-11T05:05:11.040Z*  
